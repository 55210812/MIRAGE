...
def main():
    ...
    parser.add_argument("--standard", type=bool, default=False, help="Use standard prompt instead of self-citation prompt.")
    ...
    if "16k" in args.model:
        ...
        args.max_length = 4096
    elif "zephyr" in args.model.lower():
        args.max_length = 32768
    ...
    json.dump(eval_data, open(save_path + name + ".json", "w"), indent=4)
